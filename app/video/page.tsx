    ...
    <div className="max-w-4xl mx-auto">
      ...
      <div className="mb-6 p-6 rounded-2xl border border-white/10 bg-[#161616]">
        <p className="text-sm text-[#a1a1a6] mb-4">
          Выберите сохранённый баннер и настройте анимацию. Видео создаётся на основе
          слайд-шоу или простых анимаций (текст выезжает, масштабирование).
        </p>
      ...
      <div className="mt-6 p-4 rounded-xl bg-amber-500/10 border border-amber-500/30 text-sm text-amber-200">
        ...
        FFmpeg или внешний сервис (Remotion, fal.ai и т.п.). API пока возвращает
        placeholder — в настройках Vercel добавьте сервис видео-рендеринга.
      </div>
    </div>
  );
}
